  ...
  if (user)
    return (
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent className="w-64 p-6 align" align="end">
            ...
            <DropdownMenuItem className="py-2 font-medium cursor-pointer transition-all duration-500 ease-in-out">
              ...
              >
                <div className="relative flex mr-3">
                  <Sun
                    className="dark:scale-0 dark:-rotate-90 absolute group-hover:text-yellow-600 group-hover:rotate-180 transition-all duration-500 ease-in-out"
                    size={14}
                  />
                  <Moon
          ...
          <DropdownMenuItem
            onClick={() => signOut()}
            className="group py-2 hover:bg-destructive/30 font-medium cursor-pointer transition-all duration-500"
          >
            <LogOut
              size={14}
